...
def balanced(m):
    ...
    # if is_mobile(end(left(m))) and balanced(m):
    #     return balanced(end(left(m))) 
    # if is_mobile(end(right(m))) and balanced(m):
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    ...                         tree('loki')]),
    ...                   tree('loki')])
    #yggdrasil = tree('odin',[tree('balder',[tree('loki'),tree('freya')]),tree('frigg',[tree('loki')]),tree('loki',[tree('sif'),tree('loki')]), tree('loki')])
